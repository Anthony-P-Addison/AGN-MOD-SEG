...
class Training_config():
    ...
    val_interval:int = 4 # the number of epochs between the validation
    lr:float = 1e-3            
    ...
    load_model_path:Path = None   ##"models/modality_invariant_slot/WMH_MSSEG/modality_invariant_slot_random_drop_1WMH_MSSEG_TOTAL_AVERAGE.pth"  # path to model .pt file
    ...
    #admin
    project_name:str = "all_in_one"   # wandb project name:   # all_in_one   # shuffle_slots  # modality_invariant_slot 
...
class Test_config():
    ...
    model_file_path:Path = 'models/modality_invariant_slot/_model_remove:_FLAIR/WMH_MSSEG_BRATS_ATLAS_TBI/modality_invariant_slot_random_drop_TrueWMH_MSSEG_BRATS_ATLAS_TBI2025-01-18_17-11_BEST_AVERAGE.pth' # 'models/new_test_BRATS_ATLAS_WMH_MSSEG_TBI_random_drop_0_Epoch_599.pth' #'models/Train_BRATS_TBI_ATLAS_MSSEG_WMH.pth' # "models/new_test_BRATS_ATLAS_WMH_MSSEG_TBI_random_drop_0_checkpoint_Epoch_599.pt"  # "models/MSSEG/_random_drop_0_2024-12-04_16-15_checkpoint_Epoch_99.pt" #"models/MSSEG/rand_slot_allocation_random_drop_0_2024-12-09_16-01_checkpoint_Epoch_99.pt"
    model_net_type: str = "UNET"  # the type of the pre-train model
    num_modalities_trained_on: int = 6 # the number of modalities include in training
    ...
    single_slot:bool = False
    modality_remove:str = 'DWI' #  'FLAIR'  #'T1'   # Modlality completed removed during test in dataloader. 

    modality_rem_train: str = 'FLAIR'  # the modality that was removed during training and now want to test in the invariant slot. 
