...
class Training_config():
    ...
    project_name:str = "all_in_one"   # wandb project name   # all_in_one
    model_save_path:str = "models/" + project_name + "/"
    load_model_path:Path = "models/MSSEG_ATLAS_BRATS_MSSEG_TBI/rand_slot_allocation__random_drop_0_2024-12-09_17-46_checkpoint_Epoch_199.pt"  # path to model .pt file
...
class Database_config():
    ...
    channels["ISLES"] = ["FLAIR", "T1", "T2", "PD"]      # DWI (changed to pd for teh sake of shuffle as has not been trained on DWI)
...
class Test_config():
    save_segs:bool = True  # True to save the segmentation outputs
    save_path:Path = "save_segs/"  # save nifis generated
    model_file_path:Path = 'models/standard/new_test_BRATS_ATLAS_WMH_MSSEG_TBI_random_drop_0_Epoch_599.pth' # 'models/shuffle_slots/TBI/shuffle_slots_random_drop_1_2024-12-16_15-55_BEST_TBI.pth' # 'models/new_test_BRATS_ATLAS_WMH_MSSEG_TBI_random_drop_0_Epoch_599.pth' #'models/Train_BRATS_TBI_ATLAS_MSSEG_WMH.pth' # "models/new_test_BRATS_ATLAS_WMH_MSSEG_TBI_random_drop_0_checkpoint_Epoch_599.pt"  # "models/MSSEG/_random_drop_0_2024-12-04_16-15_checkpoint_Epoch_99.pt" #"models/MSSEG/rand_slot_allocation_random_drop_0_2024-12-09_16-01_checkpoint_Epoch_99.pt"
