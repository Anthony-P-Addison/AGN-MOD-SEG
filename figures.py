...
aug_types = [
    {"name": "Original", "brain_invert": 0, "pathology_invert": 0, "lesion_switch": 0, "pathology_mixup": 0, "brain_mixup": 0, "shift_scale": 0, "Contrast": 0, 'prob_brain_scale_shift': False, 'prob_pathology_scale_shift': False},
    {"name": "Masks", "brain_invert": 0, "pathology_invert": 0, "lesion_switch": 0, "pathology_mixup": 0, "brain_mixup": 0, "shift_scale": 0, "Contrast": 0, 'prob_brain_scale_shift': False, 'prob_pathology_scale_shift': False},
    {"name": "Lesion Switch", "brain_invert": 0, "pathology_invert": 0, "lesion_switch": 1.0, "pathology_mixup": 0, "brain_mixup": 0, "shift_scale": 0, "Contrast": 0, 'prob_brain_scale_shift': False, 'prob_pathology_scale_shift': False},
    {"name": "Inversion", "brain_invert": 1.0, "pathology_invert": 1.0, "lesion_switch": 0, "pathology_mixup": 0, "brain_mixup": 0, "shift_scale": 0, "Contrast": 0, 'prob_brain_scale_shift': False, 'prob_pathology_scale_shift': False},
    {"name": "Mixup", "brain_invert": 0, "pathology_invert": 0, "lesion_switch": 0, "pathology_mixup": 1.0, "brain_mixup": 1.0, "shift_scale": 0, "Contrast": 0, 'prob_brain_scale_shift': False, 'prob_pathology_scale_shift': False, "lam_params": (0.3, 0.3)},
    {"name": "Scale & Shift", "brain_invert": 0, "pathology_invert": 0, "lesion_switch": 0, "pathology_mixup": 0, "brain_mixup": 0, "shift_scale": 1.0, "Contrast": 1.0, 'prob_brain_scale_shift': True, 'prob_pathology_scale_shift': True},
    #"name": "Random Aug #1", "brain_invert": 0.7, "pathology_invert": 0.8, "lesion_switch": 0.5, "pathology_mixup": 0.7, "brain_mixup": 0.6, "shift_scale": 1.0, "Contrast": 1.0, 'prob_brain_scale_shift': True, 'prob_pathology_scale_shift': True, "seed": 42},
    {"name": "Random Aug2", "brain_invert": 1, "pathology_invert": 1, "lesion_switch": 1, "pathology_mixup": 1, "brain_mixup": 1, "shift_scale": 1.0, "Contrast": 1.0, 'prob_brain_scale_shift': True, 'prob_pathology_scale_shift': True, "seed": 12},
    {"name": "Random Aug3", "brain_invert": 0, "pathology_invert": 0,  "lesion_switch": 1, "pathology_mixup": 0, "brain_mixup": 1, "shift_scale": 1.0, "Contrast": 1.0, 'prob_brain_scale_shift': True, 'prob_pathology_scale_shift': True, "seed": 78},
]
...
for subject_idx in subject_indices:
    ...
    plt.subplots_adjust(wspace=0.1, hspace=0.1)   # Increase spacing to fit larger text
    ...
    axes[0, 0].axis('off')
    axes[0, 0].text(0.5, -0.12, 'a) Original', transform=axes[0, 0].transAxes, 
    ...
    legend_elements = [
        Patch(facecolor='red', alpha=0.7, label='Lesion'),
    ...
    axes[0, 1].axis('off')
    axes[0, 1].text(0.5, -0.12, 'b) Masks', transform=axes[0, 1].transAxes, 
                size=11, weight='bold', ha='center')
    ...
    for idx, aug in enumerate(aug_types[2:]):  # Skip original and masks
        ...
        aug_config.prob_lesion_switch = 0
        ...
        aug_config.prob_lesion_switch = aug["lesion_switch"]
        ...
        augmented = spatial_contrast_aug(
            ...
            batch_img=img_data,
            plot_image=False,
            lam_params=aug["lam_params"] if "lam_params" in aug else (0.7, 1)
        ...
        if "Random Aug" in aug["name"]:
            ...
            title = aug["name"]
        axes[row, col].text(0.5, -0.12, f'{letter}) {title}', transform=axes[row, col].transAxes, 
                    size=11, weight='bold', ha='center')
    ...
    fig.legend(
        ...
        loc='upper center',
        bbox_to_anchor=(0.5, 0.96),  # Move legend closer to the image
        ncol=2,
        fontsize=11,
        framealpha=0.9
    )
